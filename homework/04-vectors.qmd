...
[Download the starter qmd file here](https://raw.githubusercontent.com/srvanderplas/unl-stat151/main/homework/04-vectors.qmd)
...
# write it to a file
writeLines(as.character(x), con = "hw4data-r.txt")
writeLines(as.character(y), con = "hw4data-py.txt")
```
