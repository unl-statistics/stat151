...
officehours: "https://calendly.com/drvanderplas/officehours"
office: "Hardin 349A"
classroom: "Hardin 49"
...
tibble(date = seq(ymd(20220101), ymd(20220530), by=1))  %>%
...
The primary textbook for this course is one that I have developed from other resources listed below. It is available for free at https://srvanderplas.github.io/Stat151/
...
kableExtra::kable(caption = "Tentative schedule of class topics")
```
...
If in-person classes are canceled, you will be notified of the instructional continuity plan for this class by Canvas Announcement. In most circumstances, we will continue to hold class via Zoom. 
\clearpage
